            ...
            <Animated.View
              style={[
                s.glowCircle,
                {
                  width: GLOW_R_MID * 2,
                  height: GLOW_R_MID * 2,
                  borderRadius: GLOW_R_MID,
                  left: GLOW_CX - GLOW_R_MID,
                  top: GLOW_CY - GLOW_R_MID,
            ...
            <Animated.View
              style={[
                s.glowCircle,
                {
                  width: GLOW_R_OUT * 2,
                  height: GLOW_R_OUT * 2,
                  borderRadius: GLOW_R_OUT,
                  left: GLOW_CX - GLOW_R_OUT,
                  top: GLOW_CY - GLOW_R_OUT,
            ...
            <Animated.View
              style={[
                s.glowCircle,
                {
                  width: GLOW_R_IN * 2,
                  height: GLOW_R_IN * 2,
                  borderRadius: GLOW_R_IN,
                  left: GLOW_CX - GLOW_R_IN,
                  top: GLOW_CY - GLOW_R_IN,

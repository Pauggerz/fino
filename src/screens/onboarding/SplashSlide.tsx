  ...
  useEffect(() => {
    ...
    Animated.sequence([
      ...
      Animated.parallel(
        BURST.map((cfg, i) =>
          Animated.parallel([
            Animated.spring(partX[i], {
              toValue: cfg.tx,
              tension: 42,
              friction: 6,
              useNativeDriver: true,
            }),
            Animated.spring(partY[i], {
              toValue: cfg.ty,
              tension: 42,
              friction: 6,
              useNativeDriver: true,
            }),
            Animated.timing(partOp[i], {
              toValue: 1,
              duration: 180,
              useNativeDriver: true,
            }),
  ...
  return (
    <View style={s.root}>
      ...
      <View style={s.logoGroup}>
        ...
        {/* Logo icon */}
        <Animated.View
          style={{ transform: [{ scale: logoScale }, { rotateZ: logoRotDeg }] }}
        >
          <LinearGradient

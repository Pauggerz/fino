...
export default function AuthSlide({ isActive, onComplete }: Props) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (err || !data.url)
        throw err ?? new Error('Google sign-in unavailable');
  ...
  return (
    <View style={s.root}>
      ...
      <View
        ...
        style={[
          s.bgGlow,
          { top: -80, left: -60, backgroundColor: 'rgba(30,90,52,0.28)' },
        ]}
      />
      <View
        pointerEvents="none"
        style={[
          s.bgGlow,
          {
            ...
            height: 280,
            borderRadius: 140,
            backgroundColor: 'rgba(20,70,40,0.20)',
          },
        ]}
      />
      ...
      >
        ...
        >
          ...
          <Animated.View
            style={[
              s.brand,
              { opacity: logoA, transform: [{ translateY: logoY }] },
            ]}
          >
            <LinearGradient
          ...
          <Animated.View
            style={[
              s.card,
              { opacity: cardA, transform: [{ translateY: cardY }] },
            ]}
          >
            {/* Mode toggle */}
              ...
              <View style={s.forgotBox}>
                ...
                <View style={s.forgotActions}>
                  <TouchableOpacity
                    ...
                    style={s.forgotCancelBtn}
                  >
                    <Text style={s.forgotCancelText}>Cancel</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[s.forgotSendBtn, forgotLoading && { opacity: 0.7 }]}
                  ...
                  >
                    ...
                    >
                      {forgotLoading ? (
                        ...
                        <Text style={s.submitText}>Send Link</Text>
                      )}
                    </LinearGradient>
                  </TouchableOpacity>
                </View>
          ...
          {/* Social */}
          <Animated.View
            style={[{ opacity: socialA, transform: [{ translateY: socialY }] }]}
          >
...
const s = StyleSheet.create({
  ...
  card: {
    ...
    gap: 14,
    borderWidth: 1,
    borderColor: 'rgba(168,213,181,0.10)',
    marginBottom: 20,
  },
  modeToggle: {
    flexDirection: 'row',
  ...
  successBox: {
    ...
    gap: 8,
    backgroundColor: 'rgba(91,140,110,0.15)',
    borderRadius: 10,
    padding: 12,
  },
  successText: {
  ...
  dividerLine: {
    flex: 1,
    height: 1,
    backgroundColor: 'rgba(168,213,181,0.10)',
  },
  dividerText: {
    fontFamily: 'Inter_400Regular',
    fontSize: 12,

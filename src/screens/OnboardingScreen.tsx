    ...
    <View style={s.root}>
      {Array.from({ length: SLIDE_COUNT }, (_, i) => (
        ...
        >
          ...
          {i === 5 && <AuthSlide     isActive={current === 5} onComplete={completeOnboarding} />}
        </Animated.View>
      ))}
      ...
      {showDots && (
        <View style={s.navOverlay} pointerEvents="box-none">
          ...
          {showNext && (
            <TouchableOpacity onPress={() => goTo(Math.min(current + 1, 5))} style={s.nextBtn} activeOpacity={0.8}>
...
const s = StyleSheet.create({
  ...
  dotsRow:  { flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 7 },

    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      {loading ? (
        ...
        >
          {/* ── Stats strip ── */}
          <View
            style={[styles.statsStrip, { backgroundColor: colors.primary }]}
          >
          ...
          >
            {(['all', 'pending', 'partial', 'paid'] as FilterTab[]).map(
              (tab) => (
                <TouchableOpacity
                  key={tab}
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={[styles.emptySub, { color: colors.textSecondary }]}>
                {filter === 'all'
                  ...
                  : 'Switch tabs to see other debts.'}
              </Text>
            </View>
          )}
              ...
              >
                ...
                <View style={styles.cardTop}>
                  ...
                  <View style={{ flex: 1, minWidth: 0 }}>
                    <Text
                      style={[styles.debtorName, { color: colors.textPrimary }]}
                      numberOfLines={1}
                    >
                      {debt.debtor_name}
                    </Text>
                  ...
                  <View
                    style={[
                      styles.statusBadge,
                      { backgroundColor: isDark ? `${cfg.color}33` : cfg.bg },
                    ]}
                  >
                ...
                <View style={styles.cardFooter}>
                  ...
                  {status !== 'paid' && (
                    ...
                    >
                      ...
                      />
                      <Text
                        style={[styles.payBtnText, { color: colors.primary }]}
                      >
                        Record Payment
                      </Text>
                    </TouchableOpacity>
            ...
            {payTarget && (
              <>
                ...
                >
                  ...
                  {fmt(payTarget.total_amount - payTarget.amount_paid)}{' '}
                  remaining
                </Text>
                ...
                <View style={styles.quickAmounts}>
                  {[
                    ...
                    Math.ceil(
                      (payTarget.total_amount - payTarget.amount_paid) / 2
                    ),
                  ]
                    .filter((v) => v > 0)
                    .map((v, i) => (
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      <Text
                        style={[styles.detailGridValue, { color: '#10B981' }]}
                      >
                    ...
                    <View
                      style={[styles.detailGridCell, { borderBottomWidth: 0 }]}
                    >
                      <Text
                        style={[
                          styles.detailGridLabel,

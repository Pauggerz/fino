...
export const CORPUS: CorpusRow[] = [
  ...
  { text: 'walk me through my purchases', label: 'transactions' },
  { text: 'run me through my recent spending', label: 'transactions' },
  { text: 'talk me through what i bought lately', label: 'transactions' },
  ...
  // ── runway ─────────────────────────────────────────────────────────────────
  { text: 'how long will my money last', label: 'runway' },
  { text: 'how long can my savings hold', label: 'runway' },
  { text: 'how many days until i run out of money', label: 'runway' },
  { text: 'when will i go broke at this rate', label: 'runway' },
  { text: 'what is my burn rate', label: 'runway' },
  { text: 'how fast am i burning through my money', label: 'runway' },
  { text: 'how much runway do i have', label: 'runway' },
  { text: 'if i lose my income how long can i survive', label: 'runway' },
  { text: 'how long will my balance carry me', label: 'runway' },
  { text: 'can my money stretch until next payday', label: 'runway' },

  // ── explainSpend ───────────────────────────────────────────────────────────
  { text: 'why is my spending so high this month', label: 'explainSpend' },
  { text: 'why am i spending so much', label: 'explainSpend' },
  { text: 'why are my expenses so big', label: 'explainSpend' },
  { text: 'what changed since last month', label: 'explainSpend' },
  { text: 'what is different about my spending this month', label: 'explainSpend' },
  { text: 'why did my balance go down so fast', label: 'explainSpend' },
  { text: 'what is driving my spending up', label: 'explainSpend' },
  { text: 'explain my spending this month', label: 'explainSpend' },
  { text: 'what is eating my money', label: 'explainSpend' },
  { text: 'bakit ang laki ng gastos ko', label: 'explainSpend' },

  // ── monthPattern ───────────────────────────────────────────────────────────
  { text: 'what was my cheapest month this year', label: 'monthPattern' },
  { text: 'which month did i spend the most', label: 'monthPattern' },
  { text: 'what was my most expensive month', label: 'monthPattern' },
  { text: 'which month was the priciest for me', label: 'monthPattern' },
  { text: 'show my spending month over month', label: 'monthPattern' },
  { text: 'how does my spending look by month', label: 'monthPattern' },
  { text: 'which month did i spend the least', label: 'monthPattern' },
  { text: 'what month was my lowest spending', label: 'monthPattern' },
  { text: 'compare my months of spending', label: 'monthPattern' },

  // ── upcomingBills ──────────────────────────────────────────────────────────
  { text: 'when is my next bill due', label: 'upcomingBills' },
  { text: 'what bills are coming up', label: 'upcomingBills' },
  { text: 'what bills are coming up this week', label: 'upcomingBills' },
  { text: 'what do i owe in bills this month', label: 'upcomingBills' },
  { text: 'anything due soon', label: 'upcomingBills' },
  { text: 'what payments are due this week', label: 'upcomingBills' },
  { text: 'when is rent due', label: 'upcomingBills' },
  { text: 'do i have bills coming', label: 'upcomingBills' },
  { text: 'show me my upcoming bills', label: 'upcomingBills' },
  { text: 'whats due next', label: 'upcomingBills' },

  // ── setBudget ──────────────────────────────────────────────────────────────
  { text: 'set a budget of 5000 for food', label: 'setBudget' },
  { text: 'budget 3000 for transport', label: 'setBudget' },
  { text: 'set my shopping budget to 2000', label: 'setBudget' },
  { text: 'create a budget for groceries', label: 'setBudget' },
  { text: 'make my food budget 4000', label: 'setBudget' },
  { text: 'cap my eating out at 1500', label: 'setBudget' },
  { text: 'put a 2000 budget on entertainment', label: 'setBudget' },
  { text: 'i want a monthly budget of 10000', label: 'setBudget' },
  { text: 'give me a budget for coffee', label: 'setBudget' },

  // ── deleteTransaction ──────────────────────────────────────────────────────
  { text: 'delete my last transaction', label: 'deleteTransaction' },
  { text: 'remove that last expense', label: 'deleteTransaction' },
  { text: 'delete the 500 charge', label: 'deleteTransaction' },
  { text: 'erase my latest purchase', label: 'deleteTransaction' },
  { text: 'remove my jollibee transaction', label: 'deleteTransaction' },
  { text: 'undo that last entry', label: 'deleteTransaction' },
  { text: 'delete the grab expense from yesterday', label: 'deleteTransaction' },
  { text: 'i logged that twice remove one', label: 'deleteTransaction' },
  { text: 'scrap my last purchase', label: 'deleteTransaction' },

  // ── transfer ───────────────────────────────────────────────────────────────
  { text: 'transfer 500 from gcash to bpi', label: 'transfer' },
  { text: 'move 1000 to my savings account', label: 'transfer' },
  { text: 'transfer money between my accounts', label: 'transfer' },
  { text: 'move 500 from my wallet to the bank', label: 'transfer' },
  { text: 'send 2000 from bpi to gcash', label: 'transfer' },
  { text: 'transfer 300 into my emergency account', label: 'transfer' },
  { text: 'move funds from gcash to maya', label: 'transfer' },
  { text: 'i want to transfer 1500 to my other account', label: 'transfer' },

  // ── reminder ───────────────────────────────────────────────────────────────
  { text: 'remind me to pay my electric bill', label: 'reminder' },
  { text: 'remind me to pay rent on the 5th', label: 'reminder' },
  { text: 'set a reminder for my internet bill', label: 'reminder' },
  { text: 'can you remind me about my credit card payment', label: 'reminder' },
  { text: 'dont let me forget my water bill', label: 'reminder' },
  { text: 'remind me to pay meralco 2000', label: 'reminder' },
  { text: 'set a payment reminder for netflix', label: 'reminder' },
  { text: 'remind me before my loan is due', label: 'reminder' },
